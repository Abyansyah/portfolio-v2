      ...
      <div className="container w-full px-4 lg:px-72">
        ...
        <div className="flex flex-col items-center mt-14 lg:flex-row lg:justify-between">
          <div className="w-full" data-aos="fade-up">
            <Image className="w-[410px] h-[354px] object-cover rounded-2xl" loading="lazy" src={'/img/about.webp'} width={410} height={400} alt="About" sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" />
          </div>
